   ...
   <hr />
    ...
    <div class="row">
      ...
      <div class="col-lg-9 mb-4">
          ...
          <h3>Públicos</h3>
          <br />
          <p><a href="perfil_cursos_cadastro.html"><button type="button" class="btn btn-primary">Cadastrar Público</button></a></p>
          <br />
